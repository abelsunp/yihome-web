				...
				<div class="main-content">
					...
					<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" label-position="top">
						...
						<el-form-item  prop="email">
							<el-input v-model="ruleForm.email" placeholder="请输入邮箱或手机号" prefix-icon="el-icon-user" clearable></el-input>
						</el-form-item>
						...
						<el-form-item>
							<el-button :loading="loadingStatus" class="registerBtn panpay_LoginBtn" @click="submitForm('ruleForm')" type="primary">立即登录</el-button>
						</el-form-item>
						<el-form-item>
						...
						<el-form-item class="usePhoneLogin">
							<img src="~assets/images/loginRegister/phone.svg" alt="" @click="emailLoginMode">
							<p>手机验证码登录</p>
						</el-form-item>
					</el-form>
				</div>
	...
	export default{
		...
		data() {
			...
			var validateEmail = (rule, value, callback) => {
				if(value === '') {
					callback(new Error('邮箱号码或手机号不能为空'));
				} else {
					if(value.indexOf("@") > 0) {
						//当前是邮箱号码
		...
		methods: {
			...
			userLoginFun(){
				this.$request.loginin({'account':this.ruleForm.email,'password':this.ruleForm.password}).then(res=>{
