			...
			<div class="main-wraper">
				<div class="main-content">
					...
					<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" label-position="top">
						<h1 class="title">找回忆家 YIHOME密码</h1>
						...
						<el-form-item  prop="checkPassword">
							<el-input v-model="ruleForm.checkPassword" placeholder="请再次输入密码" prefix-icon="el-icon-lock" show-password></el-input>
						</el-form-item>
						<el-form-item>
						...
						<el-form-item class="loginType">
							<div class="sigma-middle-line">
								<span class="sigma-line-text">其他找回方式</span>
							</div>
						</el-form-item>
	...
	export default{
		...
		methods: {
			...
			sendCode(){//获取验证码
				...
				if(!TestEmail.test(this.ruleForm.email)){
					//调用 Email的验证规则	 
			...
			userLoginFun(){
				this.$request.passReset({'account':this.ruleForm.email,'password':this.ruleForm.password,'code':this.ruleForm.code}).then(res=>{
