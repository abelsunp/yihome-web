...
export default {
  ...
  */
  head: {
    ...
    meta: [
      { charset: 'utf-8' },
      { hid: 'description', name: 'description', content: 'YIHOME忆家是国内领先的海外留学租房平台，租房服务包括：澳洲留学租房、英国留学租房、雷丁租房、布莱顿租房、墨尔本等海外留学租房生态圈。致力为英国和澳洲市场海外留学生提供长期租住解决方案，咨询热线：021-66610767' },
